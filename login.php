...
<head>
  ...
  <style type="text/css">
    .bg-radian{
    background-image: linear-gradient(yellow, #6495ED);
  }
  </style>
</head>
...
<div class="login-box">
  <div class="login-logo">
    <a href="" class="text-white"><b>Ap</b>likasi Inventaris</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body bg-radian">
      <p class="login-box-msg">Masuk dengan akun anda untuk login</p>
